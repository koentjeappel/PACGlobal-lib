# PACGlobal Address
Represents a PACGlobal address. Addresses are the most popular way to make PACGlobal transactions. See [the PACGlobal documentation](https://pacglobal-docs.github.io/en/glossary/address) for technical background information.
...
The errors are listed in the generated file in the [errors folder](https://github.com/koentjeappel/bitcore-pacglobal/tree/master/lib/errors). There's a structure to errors defined in the [spec.js file](https://github.com/koentjeappel/bitcore-pacglobal/tree/master/lib/errors/spec.js).

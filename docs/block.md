...
For detailed technical information about a block please visit [Blocks](https://pacglobal-docs.github.io/en/glossary/block) on the PACGlobal Wiki.
...
For more information about the specific properties of a block header please visit the [Block headers](https://pacglobal-docs.github.io/en/developer-reference#block-headers) page on the PACGlobal Developer Reference Wiki.

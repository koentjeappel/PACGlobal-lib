...
bitcore.versionGuard = function(version) {
  if (version !== undefined) {
    var message = 'More than one instance of pacglobal-lib found. ' +
      'Please make sure that you are not mixing instances of classes of the different versions of pacglobal.';
    console.warn(message);
  }
};
bitcore.versionGuard(global._pacglobal);
global._pacglobal = bitcore.version;
